 ...
 */
final class Version20191208122022 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE these ADD lien VARCHAR(255) NOT NULL, DROP lien_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE these ADD lien_id INT DEFAULT NULL, DROP lien');
